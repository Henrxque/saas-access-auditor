...
## Base de templates de arquivo (MVP)

Definições iniciais (TypeScript + Zod) para:
...
- `types/file-template-types.ts`
- `schemas/file-templates-schema.ts`

Esses templates já incluem:

- colunas obrigatórias
- colunas opcionais
- aliases aceitos por coluna
- extensões aceitas (`.csv`, `.xlsx`, `.xls`)
- limite de até 3 arquivos por auditoria
- notas de matching principal (`email`) e contexto de risco com status de RH
